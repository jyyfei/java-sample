...
class FastLoaderIndex {
  ...
  private final Map<String, List<FastLoader>> indexMap = new HashMap<String, List<FastLoader>>();
  private final List<FastLoader> fastFileLoaders = new ArrayList<FastLoader>();
