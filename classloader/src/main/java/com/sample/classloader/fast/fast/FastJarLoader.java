...
class FastJarLoader extends FastLoader {
  ...
  private static final boolean META_INF_FILENAMES = "true".equals(
      System.getProperty("sun.misc.JarIndex.metaInfFilenames"));
  ...
  private JarFile getJarFile(URL url) throws IOException {
    ...
    uc.setRequestProperty(FastURLClassPath.USER_AGENT_JAVA_VERSION, FastURLClassPath.JAVA_VERSION);
