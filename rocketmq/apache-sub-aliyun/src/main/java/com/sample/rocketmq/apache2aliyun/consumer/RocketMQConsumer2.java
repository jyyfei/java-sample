...
public class RocketMQConsumer2 {
    ...
    public static void main(String[] args) throws MQClientException {
        ...
        consumer.subscribe("Topic-Patient-Charge", MqConfig.TAG);
    ...
    public static void start2() throws MQClientException {
        DefaultMQPushConsumer consumer = new DefaultMQPushConsumer("GID-Miniapp", getAclRPCHook(),
